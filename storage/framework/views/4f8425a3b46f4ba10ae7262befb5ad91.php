...
<div>
    ...
    <div class="container">
        ...
        <div class="form-group">
            <label>Current Email: <span id="currentEmail"></span></label>
            <input type="text" id="newEmail" class="form-control" placeholder="New Email">
        </div>

        <div class="form-group">
            <label>Current Password: <span id="currentPassword"></span></label>
            <input type="password" id="newPassword" class="form-control" placeholder="New Password">
        </div>

    
        <button onclick="updateProfile()" class="confirm">Update Profile</button>
...
<?php /**PATH C:\Users\igorm\web-tech\resources\views/profile_settings.blade.php ENDPATH**/ ?>